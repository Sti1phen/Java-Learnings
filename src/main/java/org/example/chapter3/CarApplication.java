package org.example.chapter3;//Question 3.13
...
public class CarApplication
{
	...
	public static void main(String [] args)
	{
		...
		System.out.printf("Enter the model, year and the price of the first car separating them with a space: ");
		...
		System.out.printf("\n\nEnter the model, year and the price of the second car separating your input with a space: ");
