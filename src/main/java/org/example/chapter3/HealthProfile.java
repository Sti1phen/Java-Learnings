...
public class HealthProfile {
    ...
    public HealthProfile(String firstName, String lastName, int yearOfBirth, int monthOfBirth, int dayOfBirth, double height, double weight, String gender)
    {
        ...
        else if (monthOfBirth == 1 ||monthOfBirth == 3 || monthOfBirth == 5 || monthOfBirth == 7 || monthOfBirth == 8 ||monthOfBirth == 10 || monthOfBirth == 11 ||monthOfBirth == 12)
        {
