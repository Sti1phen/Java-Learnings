package main.java.org.example.chapter3;//Questionn3.12
...
public class PetrolPurchase
{
	...
	public PetrolPurchase(String location, String petrolType, int quantity, double literPrice, double discount)//Constructor initializing the five instance variables
	{
